...
//
//
//int LuaBrain::lua_TransformFunction(lua_State* L) 
//{
//	 
//	
...
//
//	LuaRequisites* luaReq = new LuaRequisites();
//	luaReq->MoveTransform(localTransform->position.x, localTransform->position.y, localTransform->position.z);
//	//MoveTransform(localTransform, x, y, z);
//	
//	return 3;
//
//}
...
//	lua_register(L_state, "MoveTransform", lua_TransformFunction);
//
...
//
////
////void LuaBrain::AssignTransform(Transform* transform)
////{
